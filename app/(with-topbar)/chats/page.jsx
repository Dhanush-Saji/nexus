...
const Page = async() => {
  ...
  return (
    <main className="flex items-center w-full flex-col relative h-[88vh] md:h-[91vh] px-3 py-[2vh] overflow-hidden">
      <div className="grid grid-col-1 md:grid-cols-[30%,70%] w-full bg-[#1a2337] rounded-[10px] border border-gray-50/10 h-[84vh] md:h-[87vh]">
